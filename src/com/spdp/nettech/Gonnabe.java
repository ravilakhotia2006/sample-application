...
public class Gonnabe extends ListActivity{
	...
	private ArrayList<Integer> campus_id ;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(campusname_list.isEmpty() == true)
		{
			...
			list.setAdapter(new AdapterCampusDetails(Gonnabe.this, campusname_list));
	...
	private void connect_and_fetch_data() {
        ...
        try{
        	...
        	HttpPost httppost = new HttpPost("http://10.0.2.2/gonnabe.php");
