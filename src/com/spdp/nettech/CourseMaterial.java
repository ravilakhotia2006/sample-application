...
public class CourseMaterial extends Activity {

	private String fileLink;
	private final String PATH = "/data/data/com.spdp.nettech/course/";
	private String cname ;
	private ArrayList<Files> filenames ;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//cname = b.getString("CAMPUS_NAME").toString();
		//Log.d("name", cname);
		//setTitle(cname);
		...
		list.setAdapter(new AdapterCourseMaterial(CourseMaterial.this, filenames));
		
		
		/*list.setOnItemClickListener(new OnItemClickListener(){
			public void onItemClick(AdapterView<?> av, View v, int pos, long id) {
				switch(pos){
				case 0: {fileLink = "Basic_Commands.pdf";break;}
				case 1: {fileLink = "dos.pdf";break;}
				case 2: {fileLink = "OS-pre-course-study.pdf";break;}
				case 3: {fileLink = "File-Systems.pdf";break;}
				}
		...
		private void connect_and_fetch_data() {
	        ...
	        try{
	        	...
	        	HttpPost httppost = new HttpPost("http://10.0.2.2/filename.php");
	...
	public void DownloadFile(String fileName) {  
        try {
                URL url = new URL("http://10.0.2.2/course/" + fileName); 
